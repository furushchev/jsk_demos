...
class RectArrayToPoseArray(ConnectionBasedTransport):
    def __init__(self):
        super(RectArrayToPoseArray, self).__init__()
...
if __name__ == '__main__':
    rospy.init_node("rect_array_to_pose_array")
    n = RectArrayToPoseArray()
    rospy.spin()
